...
// llamamos al modelo/schema de Movie
const Movie = require("../models/Movie.model.js");

// ahora la magia de mongoose > insertamos la data en la base de datos
...
mongoose
  ...
  .then((response) => {
    console.log("Data agregada correctamente en la base de datos");
  })
  .catch((error) => {
    console.log(error);
  });
